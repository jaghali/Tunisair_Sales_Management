...
const EnteteVenteForm = ({ enteteVente, onClose, onSave }) => {
  ...
  useEffect(() => {
    if (enteteVente) setFormData(enteteVente);
  }, [enteteVente]);
  ...
  return (
    <Dialog open={true} onClose={onClose} fullWidth maxWidth="md">
      <DialogTitle>{enteteVente ? "Modifier" : "Ajouter"} un état de vente</DialogTitle>
      <DialogContent>
...
export default EnteteVenteForm;
