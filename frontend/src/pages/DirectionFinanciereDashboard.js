    ...
    <div style={styles.container}>
      ...
      <main style={styles.main}>
        {loading ? (
          ...
          >
            {[{ name: "Revendance", icon: PackageSearch, value: articleCount, color: "#C80505" },
              { name: "Troux de Caisse", icon: Users, value: fournisseurCount, color: "#C80505" },
              { name: "Commission", icon: ShoppingBag, value: pnCount, color: "#C80505" }
            ].map((stat, index) => (
              <motion.div
                key={stat.name}
